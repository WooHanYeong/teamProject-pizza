...
<link rel="stylesheet" type="text/css" href="css/productdetail1.css" > 
	...
	*/
	function order_create_form() {
		if (<%=!isLogin%>) {
			...
			document.product_detail_form.action = 'order_into_form.jsp';
                                ...
                                <div class="detail-wrap">
                                    ...
                                    <div class="select-box">
                                        <div class="step-wrap">
                                            ...
                                            -->
                                            <form action="product_update_action.jsp" method="post"
												id="cart_update_form_<%=%>">
                                            <div class="step-wrap">
                                                <div class="title-wrap">
